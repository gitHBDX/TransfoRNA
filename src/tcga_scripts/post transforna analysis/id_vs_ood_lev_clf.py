...
if __name__ == "__main__":
    #######################################TO CONFIGURE#############################################
    path = f'models/tcga/TransfoRNA_ID/sub_class/{sys.argv[1]}/embedds' #edit path to contain path for the embedds folder, for example: transforna/results/seq-rev/embedds/
